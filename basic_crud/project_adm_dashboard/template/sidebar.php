...
<!--        <ul class="item-nav">-->
            ...
            <li class="spacer"></li>
            <li class="item-menu">
                <a href="<?php echo $url; ?>categories_add.php" class="item-link">

                    <span><i class="feather-plus-circle"></i>Add Categories</span>
                </a>
            </li>
            <li class="item-menu">
                <div class="item-list-menu">
                    <a href="<?php echo $url; ?>categories_list.php" class="item-link">

                        <span><i class="feather-list"></i>Categories List</span>
                        <span class="badge badge-pill bg-light text-primary shadow-sm"
                        >15</span
                        >
                    </a>
